...
export const SelectMemberCard = ({ text }: SelectMemberCardProps) => {
    return <div className="h-10 flex rounded-lg mb-1 mr-1 shadow-md cursor-pointer group">
        <div className="h-full bg-[#653AD847] border border-r-0 border-transparent rounded-l-lg p-2 flex items-center justify-center mr-0.5 group-hover:border-white transition-colors duration-300 ease-in-out ">
            {text}
        </div>
